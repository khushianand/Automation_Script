...
from tabs.make_new_report.excel_writer.fast_rows import append_template_rows
...
def _add_pie(ws, title: str, source_row: int, source_col: int, size: int, anchor: str):
    ...
    if chart.series:
        ...
        for point in chart.series[0].data_points:
            point.graphicalProperties.line.solidFill = "000000"
...
def _add_bar(ws, title: str, source_row: int, source_col: int, rows: int, cols: int, anchor: str, *, height: float = DASHBOARD_CHART_HEIGHT, width: float = DASHBOARD_CHART_WIDTH):
    ...
    for idx, series in enumerate(chart.series):
        ...
        series.graphicalProperties.line.solidFill = "00000"
